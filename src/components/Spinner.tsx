...
export class Spinner extends React.Component<SpinnerProps> {
  ...
  render() {
    ...
    return (
      <div className={cx(`Spinner-wrap`, className)}>
              ...
              <>
                ...
                <div
                  className={cx(
                    `Spinner-content`,
                    {
                      [`Spinner-content--withchild`]: !!children,
                ...
                >
                  <div
                    className={cx(`Spinner`, spinnerClassName, {
                      [`Spinner--${size}`]: ['lg', 'sm'].includes(size),
                      [`Spinner--default`]: !icon,
                      [`Spinner-icon`]: icon,
                      [`Spinner-custom-icon`]: isCustomIcon
                    })}
                  >
                    {icon ? (
                      isCustomIcon ? (
